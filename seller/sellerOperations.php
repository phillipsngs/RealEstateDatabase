...
function handleUpdateRequest() {
    ...
    if ($fullname != "") { 
        ...
        $query = $query .  " targetprice='".$targetprice."'";
    } else if ($phone != "") { 
    ...
    // executePlainSQL("UPDATE seller SET name='" . $new_name . "' WHERE name='" . $old_name . "'");
...
function handleInsertRequest() {
    ...
    $tuple = array (
        ":bind1" => $_POST['sellerid'],
        ":bind2" => $_POST['fullname'],
        ":bind3" => $_POST['email'],
        ":bind4" => $_POST['targetprice'],
        ":bind5" => $_POST['phone'],
    );
    ...
    executeBoundSQL("insert into seller values (:bind1, :bind2, :bind3, :bind4, :bind5)", $alltuples);
    OCICommit($db_conn);
}
