...
function handleInsertRequest() {
    ...
    executeBoundSQL("insert into amenity values (:bind1, :bind2)", $alltuples);
    OCICommit($db_conn);
}
...
function handleSelectRequest() {
    ...
    $query = "select * from amenity where" ;
    ...
    if(isset($_POST['equality'])){
        $selectComparison = $_POST['equality'];
