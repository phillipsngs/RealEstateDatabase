...
function handleInsertRequest() {
    ...
    executeBoundSQL("insert into propertyoversees values (:bind1, :bind2, :bind3, :bind4)", $alltuples);
    OCICommit($db_conn);
}
...
function handleSelectRequest() {
    ...
    $query = "SELECT * FROM propertyOversees WHERE" ;
