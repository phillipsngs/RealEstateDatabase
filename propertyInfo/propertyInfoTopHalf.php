    ...
    <div class = "container-fluid">
        ...
        <div class = "row">
            ...
            <main role = "main" class = "col-md-9 ml-sm-auto px-md-4">
                ...
                <div class="row">
                        <p class= "display-4 m-2">Property Info</p>
                        ...
                        <form method="POST" action="propertyInfoDelete.php">
                            <button type="submit" class="btn btn-light m-4" name = "delete">Delete</button>
                        </form>
                        <form method="POST" action="propertyInfoView.php">
                            <button type="submit" class="btn btn-light m-4" name = "view">View</button>
                        </form>
                        <form method="POST" action="propertyAllCanAfford.php">
                             <button type="submit" class="btn btn-light m-4" name = "allAffordable">Find All the properties that every buyer can afford</button>
                        </form>
                </div>