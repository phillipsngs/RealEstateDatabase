...
function handleUpdateRequest() {
    ...
    // executePlainSQL("UPDATE branch SET name='" . $new_name . "' WHERE name='" . $old_name . "'");
...
function handleInsertRequest() {
    ...
    executeBoundSQL("insert into branch values (:bind1, :bind2, :bind3, :bind4)", $alltuples);
    OCICommit($db_conn);
}
